...
contract UNKS is ERC721A, Ownable {
    ...
    constructor() ERC721A("Unks", "UNKS") {
        ...
        unkdata.allowListStartTime = 1661608800;
        unkdata.publicStartTime = 1661695200;
        unkdata.hasTeamMinted = false;
        unkdata.isRevealed = false;
        unkdata.unrevealedURI = "https://unks.s3.amazonaws.com/preview/prereveal.json";
    }
    ...
    {
        if (
            block.timestamp < unkdata.allowListStartTime ||
            block.timestamp > unkdata.publicStartTime
        ) {
